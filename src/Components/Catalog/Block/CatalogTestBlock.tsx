...
export const CatalogTestBlock = (props: IItems) => {
  ...
  return (
    <>
      <div onClick={() => GET_BY_ID(props._id)} className="card">
        <Link to="/marketplace_soket/item">
        ...
        <div className="card-subcontent">
          ...
          <div className="card-footer">
            <span className="text-title-price">₴{props.price}</span>
            <div className="card-button" onClick={() => PUSH_BASKET_ITEM(props._id)}>
...
export default CatalogTestBlock;
